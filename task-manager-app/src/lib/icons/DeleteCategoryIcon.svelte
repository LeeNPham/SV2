<script lang="ts">
	...
	export let Class = 'h-5 w-f fill-red-600 hover:fill-red-600/50'
</script>

<svg viewBox="0 0 576 512" role="img" id={category?.title != 'All' ? (category?.id ?? category?._id ?? '') : ''} class={Class}
